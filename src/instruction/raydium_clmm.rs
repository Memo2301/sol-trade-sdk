...
impl InstructionBuilder for RaydiumClmmV2InstructionBuilder {
    async fn build_buy_instructions(
        ...
        println!("🎯 [CLMM_V2_BUY] Creating ATA initialization instructions and WSOL wrapping");
        ...
        println!("🎯 [CLMM_V2_WSOL] User WSOL ATA: {}", wsol_ata);
        ...
        println!("🎯 [CLMM_V2_WSOL] Added transfer {} lamports to WSOL ATA", params.sol_amount);
        ...
        println!("🎯 [CLMM_V2_WSOL] Added sync_native instruction to wrap SOL");
        ...
        println!("✅ [CLMM_V2_BUY] Created {} ATA initialization instructions", instructions.len());
        ...
        // 🔧 WSOL UNWRAPPING: Close WSOL ATA to unwrap any leftover WSOL back to SOL
        println!("🎯 [CLMM_V2_BUY_WSOL] Adding WSOL unwrapping instruction for leftover WSOL");
        ...
        println!("🎯 [CLMM_V2_BUY_WSOL] Added close_account instruction to unwrap leftover WSOL");
        
        println!("✅ [CLMM_V2_BUY] Total instructions: {}", instructions.len());
    ...
    async fn build_sell_instructions(
        ...
        println!("🎯 [CLMM_V2_SELL] Creating ATA initialization instructions");
        ...
        println!("🎯 [CLMM_V2_SELL_WSOL] User WSOL ATA: {}", wsol_ata);
        ...
        println!("✅ [CLMM_V2_SELL] Created {} ATA initialization instructions", instructions.len());
        ...
        // 🔧 WSOL UNWRAPPING: Close WSOL ATA to unwrap WSOL back to SOL after sell
        println!("🎯 [CLMM_V2_SELL_WSOL] Adding WSOL unwrapping instruction");
        instructions.push(spl_token::instruction::close_account(
            &spl_token::ID,
            &wsol_ata,
            &params.payer.pubkey(), // destination for unwrapped SOL
        ...
        println!("🎯 [CLMM_V2_SELL_WSOL] Added close_account instruction to unwrap WSOL");
        
        println!("✅ [CLMM_V2_SELL] Total instructions: {}", instructions.len());
...
impl RaydiumClmmV2InstructionBuilder {
    ...
    fn build_swap_instruction(
        ...
        println!("🎯 [CLMM_V2_ATA] Derived our ATAs:");
        println!("   WSOL ATA: {}", wsol_token_account);
        println!("   Token ATA: {} (for {})", mint_token_account, token_mint);
        ...
        if is_buy {
            ...
            println!("🔄 [CLMM_V2_SELL] Swapping tick array positions 15 and 16 for sell:");
